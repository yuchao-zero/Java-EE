...
<div class="i_bg bg_color">
    ...
    <div class="m_content">
        <div class="m_left">
            ...
            <div class="left_m">
                ...
                <ul>
                    ...
                    <li><a href="address.do" class="now">收货地址</a></li>
                    <li><a href="#">缺货登记</a></li>
                    <li><a href="#">跟踪订单</a></li>
                </ul>
            </div>
        ...
        <div class="m_right">
            ...
            <div class="address">
                <%
                    Object object2 = session.getAttribute("addressList");
                    if(object2 != null){
                        List<Address> addressList = (List<Address>)object2;
                ...
                <table border="0" class="add_t" align="center" style="width:98%; margin:10px auto;" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td colspan="2" style="font-size:14px; color:#ff4e00;"><%=address.getRemark()%></td>
                    </tr>
                    <tr>
                ...
                <p align="right">
                    <a href="#" style="color:#ff4e00;"><%=(address.getIsDefault() == 1)?"默认地址":"设为默认"%></a>&nbsp; &nbsp; &nbsp; &nbsp; <a href="#" style="color:#ff4e00;">编辑</a>&nbsp; &nbsp; &nbsp; &nbsp;
                </p>
                <%
                        }
                    }
